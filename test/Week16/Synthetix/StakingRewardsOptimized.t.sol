...
import {StakingRewardsOptimized} from "./../../../contracts/Week16/Synthetix/StakingRewardsOptimized.sol";
import { ERC20Token } from "./../../../contracts/Week2/ERC20Token.sol";


contract StakingRewardsOptimizedTest is Test {
    address public alice = address(0x1);
    address public bob = address(0x2);
    address public eve = address(0x3);
    address public rewardsDistribution = address(0x4);

    StakingRewardsOptimized stakingRewards;
